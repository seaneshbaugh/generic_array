...
#define __GENERIC_ARRAY_TYPE__ double

#define __GENERIC_ARRAY_NAME__ DoubleArray
...
#define GENERIC_ARRAY_ELEMENT_TO_STRING_BUFFER_SIZE(element) 3 + DBL_MANT_DIG - DBL_MIN_EXP

#define GENERIC_ARRAY_ELEMENT_TO_STRING_LENGTH(buffer, bufferSize, element) snprintf(buffer, bufferSize, "%f, ", element)

#define GENERIC_ARRAY_ELEMENT_TO_STRING_LAST_LENGTH(buffer, bufferSize, element) snprintf(buffer, bufferSize, "%f", element)

#define GENERIC_ARRAY_ELEMENT_TO_STRING(buffer, bufferSize, element) snprintf(buffer, bufferSize, "%f, ", element)

#define GENERIC_ARRAY_ELEMENT_TO_STRING_LAST(buffer, bufferSize, element) snprintf(buffer, bufferSize, "%f", element)
