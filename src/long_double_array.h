...
#define __GENERIC_ARRAY_TYPE__ long double

#define __GENERIC_ARRAY_NAME__ LongDoubleArray
...
#define GENERIC_ARRAY_ELEMENT_TO_STRING_BUFFER_SIZE(element) 3 + LDBL_MANT_DIG - LDBL_MIN_EXP

#define GENERIC_ARRAY_ELEMENT_TO_STRING_LENGTH(buffer, bufferSize, element) snprintf(buffer, bufferSize, "%Lf, ", element)

#define GENERIC_ARRAY_ELEMENT_TO_STRING_LAST_LENGTH(buffer, bufferSize, element) snprintf(buffer, bufferSize, "%Lf", element)

#define GENERIC_ARRAY_ELEMENT_TO_STRING(buffer, bufferSize, element) snprintf(buffer, bufferSize, "%Lf, ", element)

#define GENERIC_ARRAY_ELEMENT_TO_STRING_LAST(buffer, bufferSize, element) snprintf(buffer, bufferSize, "%Lf", element)
