...
#define __GENERIC_ARRAY_TYPE__ float

#define __GENERIC_ARRAY_NAME__ FloatArray
...
#define GENERIC_ARRAY_ELEMENT_TO_STRING_BUFFER_SIZE(element) 3 + FLT_MANT_DIG - FLT_MIN_EXP
