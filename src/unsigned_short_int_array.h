...
#define __GENERIC_ARRAY_TYPE__ unsigned short int

#define __GENERIC_ARRAY_NAME__ UnsignedShortIntArray
...
#define GENERIC_ARRAY_ELEMENT_TO_STRING_LENGTH(buffer, bufferSize, element) snprintf(buffer, bufferSize, "%u, ", element)

#define GENERIC_ARRAY_ELEMENT_TO_STRING_LAST_LENGTH(buffer, bufferSize, element) snprintf(buffer, bufferSize, "%u", element)

#define GENERIC_ARRAY_ELEMENT_TO_STRING(buffer, bufferSize, element) snprintf(buffer, bufferSize, "%u, ", element)

#define GENERIC_ARRAY_ELEMENT_TO_STRING_LAST(buffer, bufferSize, element) snprintf(buffer, bufferSize, "%u", element)
